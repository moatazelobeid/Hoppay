...
function file_get_html($url, $use_curl = true, $use_include_path = false, $context=null, $offset = -1, $maxLen=-1, $lowercase = true, $forceTagsClosed=true, $target_charset = DEFAULT_TARGET_CHARSET, $stripRN=true, $defaultBRText=DEFAULT_BR_TEXT, $defaultSpanText=DEFAULT_SPAN_TEXT)
{
...
class simple_html_dom
{
    ...
    function load_file()
    {
		...
		//$this->load(call_user_func_array('fget_contents', $args), true); //kishor
