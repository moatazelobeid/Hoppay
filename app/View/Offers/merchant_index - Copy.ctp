                                        ...
                                        <?php if(!empty($offerlist))
										{
											...
											{?>
                                                <tr>
                                                    ...
                                                    <td style="text-align: center;"><?=htmlspecialchars_decode($offer['Offer']['offer_title'])?></td>
                                                    <td style="text-align: center;">
													<?php if($offer['Offer']['offer_type']==1)echo 'Discount';
													else echo 'Coupon Code';?>
                                                    </td>
                                                    <td style="text-align: center;"><?php echo $offer['Offer']['discount']?></td>
