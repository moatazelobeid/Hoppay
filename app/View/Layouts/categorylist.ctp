...
/*function displaySubChilds(pid)
{
	...
	if(hchild_val == 0)
	{
		$('#hchild_'+pid).append('<span id="loading_'+pid+'"><br><img src="<?=$this->webroot?>images/ajax-loader.gif" alt="" /></span>');
		...
		$.get(url,function(data)
		{
			...
			//$('#hchild_'+pid).click();
			$('#has_child_icon_'+pid).html('<img src="<?=$this->webroot?>images/minus.png" alt=""  />');
	...
	else
	{
		if(hchild_val == 1)
		{
			$('#has_child_icon_'+pid).html('<img src="<?=$this->webroot?>images/plus.png" alt=""  />');	
			setTimeout(createlist,1001);
                          ...
                          { 
                           ...
                           <?php }?>               
             					<div class="cat_tab <?=($i==0)?'active':''?>" id="cat_tab<?=$product_category['Product_category']['id']?>" >
                                    ...
                                    <span class="sub_clcik" onclick="catlist.checkTabs(this,'<?=$product_category['Product_category']['id']?>');">
                                    	<?=$pcat_lang_data['category_name']?> (<?=$countprod?>)
                                    </span> 
                                    <?php
                                    ...
                                    {?>
                                      ...
                                      <span class="cat_icon">
                                         <a href="<?=$this->webroot?><?=$this->Template->getLang()?>/products/category-<?=$product_category['Product_category']['slug']?>">
                                          <img src="<?php echo $this->webroot.$product_category['Product_category']['icon_url'];?>"  alt="" />
                                        </a>
                                        </span>
                                    <?php }
                                    else
