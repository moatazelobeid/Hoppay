...
<div class="wrap">
		...
		<div class="content">
			...
			<div class="logo">
				<h1><a href="#"><img src="<?=$this->webroot?>images/errorpage/404.png"></a></h1>
				<span><img src="<?=$this->webroot?>images/errorpage/signal.png">Oops! The Page you requested was not found!</span>
			</div>
