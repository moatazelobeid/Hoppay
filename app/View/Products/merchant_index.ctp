        ...
        <input type="submit" class="search_button" name="search" value="Search" placeholder="Search by here."> 
           ...
           echo $this->Paginator->numbers(array('separator' => ''));
            ...
            ?>
                ...
                <?php } else{ ?>
                	<tr>
                		<td colspan="6"><center><h1>No Product Found</h1>
              ...
              <?php if(!empty($product_info))
                    { ?>
               <center><a class="btn21" style="font-weight:normal;width:50%;float:none" href="<?=$this->webroot?>merchant/my-products/download">Export your product as feed format</a></center>
               <?php }else{ ?>
                <center><a class="btn21" style="font-weight:normal;width:50%;float:none;background: #E0E0E0;
color: #000 !important;" href="javascript:void(0)">Export your product as feed format</a></center>
              <?php } ?>
				</div>
