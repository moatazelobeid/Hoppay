				...
				<?=$this->element('merchant/dashbord_left_sidebar')?>
					...
					<div class="prof_data_bg">
						...
						<div class="prof_data1">
							<?php echo "<center>Sorry, We are not found any data like this.<br> <a href='".$this->webroot.$this->Template->getLang()."/merchant/my-products'>Back to My Products</a></center>"; ?>
						</div>
