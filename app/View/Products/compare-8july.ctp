 ...
 <link href="<?=$this->webroot?>owl/owl.carousel.css" rel="stylesheet">
 <link href="<?=$this->webroot?>owl/owl.theme.css" rel="stylesheet">
 <script type="text/javascript" src="<?=$this->webroot?>js/front-end/jquery-ui-1.8.24.custom.min.js"></script>
 <script src="<?=$this->webroot?>owl-carousel/owl.carousel.js"></script>
                      ...
                      <div class="product_topsec" style="margin-top:5px;">
                          ...
                          <div class="product_topsec_det">
                                    <div itemscope="" itemtype="#">
                                      ...
                                      By <a href="<?php echo $brand_link;?>" style="font-weight: bold;"><?=@$brand['Product_brand_lang'][0]['brand_title']?></a>
                                      <?php } ?>
...
float: left;">
                            ...
                            <div id="product-description-truncated">
                                 ...
                                 <!--<table class="" cellpadding="2">
                                                    ...
                                                    <tbody>
                                                       <tr height="30">
														...
														if(!empty($product['Product']['offer_id']) && ($product['Product']['Offer']['end_date'] >= $cdate) && ($product['Product']['Offer']['status'] == 1))
														{
															...
															echo '<s>'.$this->Template->getPriceFormat(number_format($product['Product']['price'],2)).' ('.$product['Product']['Offer']['discount'].'%)</s>';
															echo '&nbsp;&nbsp;'.$this->Template->getPriceFormat(number_format($pprice,2));
															echo '</div>';
														}
														else
														{
															$pprice = $product['Product']['price'];
															
															//if(is_float($pprice))
																$pprice = number_format($pprice,2);
															
															echo '<div style="font-size: 25px;color: #c00;">'.$this->Template->getPriceFormat($pprice).'</div>';
														}?>
											...
											//{?>
                                                <div class="clear" style="height:10px;"></div>
                                            	<a href="javaScript:void(0);" onclick="scrollUpthree('three','')">See More</a>
                                            <?php //}?>
                            </div>
                          ...
                          <div class="detailspricepan">
                            ...
                            <h3>    
								...
								if(!empty($merchantids))
								{
									foreach($merchantids as $merchantid_data)
									{
										if($merchantid_data['Product']['offer_price'] == $min_price)
										{
											...
											$pname = $merchantid_data['Product_lang'][0]['title'];
                                ...
                                {?>
									...
									onClick="clickTrack('<?=$min_price_purl?>','<?=$min_price_pid?>','<?=$min_price_mid?>','<?=$min_price_price?>','<?=$merchant_logo?>','<?=$merchant_website?>','<?=$pimage?>','<?=$pname?>');"
									class="shop_by_btn_plus" >Shop By</a>
                                <?php }?>
                       ...
                       <div class="border45" id="one"></div>
                                     ...
                                     <div>
                                        ...
                                        <div class="clear" style="height:5px;"></div>
                                         ...
                                         <table class="panelstone"  id="priceWise" cellpadding="0" cellspacing="0">
                                            <tr>
                                                <td class="maintop" style="font-weight:normal;">Seller</td>
                                                <td class="maintop" style="font-weight:normal;">
                                                  <a href="javascript:void(0)" data-select="bottom" class="sellerrating sorted123">Price</a>
                                                 <!-- <span class="sellerrating">Price</span>--></td>
                                                <td class="maintop" style="font-weight:normal;">
                                                  <a href="javascript:void(0)" data-select="bottom" class="totalprice">Total Price</a>
                                                </td>
                                                <td class="maintop" style="font-weight:normal;"><a href="javascript:void(0)" data-select="bottom" class="pricedot">Seller Rating</a></td>
                                                <td class="maintop" style="font-weight:normal;">Delivery</td>
                                                <td class="maintop" style="font-weight:normal;">Payment Method</td>
                                                <!--<td class="maintop">Details</td>-->
                                                <td class="maintop" style="font-weight:normal;">Buy Now</td>
                                            </tr>
                                                <?php  
                                       ...
                                       ?>
                                            <?php foreach ($merchantids as $key => $value) { 
                                              ...
                                              $avgrate=(array_sum($rresults)/count($rresults));
												...
												$pname = $value['Product_lang'][0]['title'];
                            ...
                            //echo  $total_price_filter;
                                                ...
                                                <td class="maintop1" align="center">
                                                    ...
                                                    <font style="position:relative; top: -26px;left: 15px;color: gray;font-size: 11px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(<?=$rcount?>)</font>
                                                    <div class="clear"></div>
                                                  </div>
                                                </td>
                                                <td class="maintop1">
												...
												if(!empty($payment_methods))
												{
													...
													foreach($payment_methods as $pmethod=>$pval)
													{
														if($pval == 1)
														{
															if($pmethod == 'visa')
															{
																echo '<img src="'.$this->webroot.'images/front-end/Payment-method/visa.jpg" style="height:15px; width:26px;"> ';
															}
															if($pmethod == 'paypal')
															{
																echo '<img src="'.$this->webroot.'images/front-end/Payment-method/paypal.jpg" style="height:15px; width:26px;"> ';
															}
															if($pmethod == 'mastercard')
															{
																echo '<img src="'.$this->webroot.'images/front-end/Payment-method/mastercard.jpg" style="height:15px; width:26px;"> ';
															}
															if($pmethod == 'SADAD')
															{
																echo '<img src="'.$this->webroot.'images/front-end/Payment-method/sadad.gif" style="height:15px; width:26px;"> ';
															}
															if($pmethod == 'wire_transfer')
															{
																echo '<img src="'.$this->webroot.'images/front-end/Payment-method/wire_transfer.png" style="height:15px; width:26px;"> ';
															}
															if($pmethod == 'cod')
															{
																$cod = 1;
                                                ...
                                                <td class="maintop1" style="padding-right:0;">
                                                    ...
                                                    onClick="clickTrack('<?=$value['Product']['product_url']?>','<?=$value['Product']['id']?>','<?=$value['Product']['retailer_id']?>','<?=$product_price?>','<?=$merchant_logo?>','<?=$merchant_website?>','<?=$pimage?>','<?=$pname?>');" title="Shop Now"><img src="<?=$this->webroot?>images/front-end/cart.png">Shop Now</a>
                                                </td>
                                            </tr>
        ...
        <?php 
          if(!empty($products))
          {
            ...
            foreach($products as $prod)
            {
              ...
              if($i%6 == 0)
              {?>
                <ul id="productsCatalog list" id="owl-demo" class="owl-carousel">
              <?php }?>
                      <?php if($lang == 'en')
    					  {
                    ...
                    <?php 
                                       ...
                                       // echo $this->Html->image($pimage, array('alt' => $product_name,'url' => array('controller' => 'homes','action' => 'produc-detail','type'=>$product_name_slug,'full_base' => true)));
                                        ?>
                                        <a href="<?=$this->webroot?><?=$this->Template->getLang()?>/products/<?=$prod['Product']['id']."-".$product_name_slug?>">
                                        <?php
                  ...
                  onClick="clickTrack('<?=$prod['Product']['product_url']?>','<?=$prod['Product']['id']?>','<?=$prod['Merchant']['id']?>','<?=$prod['Product']['offer_price']?>','<?=$prod['Merchant']['image_url']?>','<?=$prod['Merchant']['url']?>','<?=$pimage?>','<?=$product_name?>');"
                  class="shop_by_btn" >  
                  <?php 
        ...
        <?php /*?><?php */?>
                            ...
                            <div id="login-box1" class="login-popup" style="top:15%;">
                                ...
                                <form id="loginForm" class="form1" style="border:none;" method="post" >
