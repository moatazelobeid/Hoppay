...
<?php /*?> <script src="<?=$this->webroot?>js/front-end/jquery.elevatezoom.min.js" type="text/javascript"></script><?php */?>
<style> 
a.sorted
{
	font-weight:bold;
                            ...
                            <div class="slide_details">
                                <div id="slide_details1">
								 ...
								 ?>
                                   ...
                                   <img border="0" src="<?=$value?>" class="product_img" data-zoom-image="<?=$value?>" alt="" title="" />
