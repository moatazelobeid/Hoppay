...
if(time>=0)
{
  ...
  if(time==0)
  {
  window.location="<?=$this->Html->url(array('controller' => 'merchant', 'action' => 'dashbord','lang'=>isset($this->params['lang'])?$this->params['lang']:'en'))?>";
  }
}
     ...
     <div class="clear" style="height:15px;">&nbsp;</div>
                <div class="newheadertwo">
                    ...
                    <div id="header" class="header_main">
                            <a <?php /*$this->Template->CreateParamLink(array('controller' => 'merchant','action' => 'signup',1))*/ ?> class="active">
                            ...
                            <a <?php /*$this->Template->CreateParamLink(array(                                        
                                             'controller' => 'merchant',
                            ...
                            <a <?php /*$this->Template->CreateParamLink(array(                                        
                                             'controller' => 'merchant',
                                             'action' => 'signup',3))*/?>><div id="header3" class="left left2per  ">
                                ...
                                <div id="managefin" class="left  widthresp">
                                  ...
                                  <br>
                                  <span class="subheading">SET UP LOGIN ACCESS</span>
                                </div>
                            ...
                            <a <?php /*$this->Template->CreateParamLink(array(                                        
								...
								<div id="Access2" class="left number_header margin-notop greencolor">
                                  <span class="image_step4"></span>
                                </div>
                                <div id="accessacnt" class="left  widthresp">
                                  <span class="heading1 greencolor">Confirmation</span>
                                  <br>
...
<div style="border: 1px solid #DBDADA;padding: 25px;border-radius: 6px;">
    ...
    <form name="loginform" id="loginform" class="loginregisterform" style="display: block;">
                <div class="div60x newlable" style="width:100%;">
                  
                  <h2 class="signup_success_final">Thanks for creating a Hoppay merchant account.</h2>
                  <div class="pleasewait" style="color:#000;">Please wait for a moment while Page is redirected to Hoppay merchant dashboard</div>
                          <h3 style="text-align: center;color: #FF8705;font-weight: normal;font-size: 22px;">Please Wait...<br><span id="timer">5 Sec</span></h3> 
                </div>
						...
						<div id="step1" class="loginform" style="width: 95%;">
							<form name="loginform" id="loginform" class="loginregisterform" style="display: block;">
								<div class="div60x newlable" style="width:100%;">
									...
									<h2 style="text-align:center;">Thanks for creating a Mena Compare merchant account.</h2>
									<lable  style="text-align:center;display: inline-block;">Please wait for a moment while Page is redirected to Mena compare merchant dashboard</lable>
                          <h3 style="text-align: center;color: #CECECE;font-weight: normal;">Please Wait...<br><span id="timer">5 Sec</span></h3> 
								</div>
