   <div class="merchantlist">
       ...
       <div class="get_new" style="position:relative"> <a class="cta__button cta__button--small widthfixed" href="<?=$this->webroot?><?=$this->Template->getLang()?>/merchant/signup" style="margin-bottom:0;box-shadow:none!important;">Get started</a><div class="freetag1"><img src="<?=$this->webroot?>img/arrow_next.png" hspace="10"/><span class="free_text">It's free</span></div></div>
          ...
          <div>
            ...
            $i=1;
             foreach (array_values($attrs) as $key => $value) { 
              ...
              ?>
               <div class="imgpanel<?=$i?>"><img src="<?=$this->webroot?><?=$value->img?>" style="width: 358px;" alt="" /></div>
            <div class="merchantright<?=$i?>">
              ...
              <img src="<?=$this->webroot?>images/merchant/images/arrowmrchnt1.png" alt="" style="position:relative; left: -8em;top: -1em; display:none;" />

            </div>
             <div class="clear"></div>
            <img src="<?=$this->webroot?>images/merchant/mm-btm-shad.png" alt="" style="position:relative;right:4%; float:right; display:none;" />
           ...
           <?php /* ?> <div class="imgpanel2"><img src="<?=$this->webroot?><?=$attrs[1]->img?>" alt="" /></div>
            <div class="merchantright2">
              ...
              <img src="<?=$this->webroot?>images/merchant/arrowmrchnt2.png" alt="" style="position:relative; left: 30em;top: 0em; display:none;" />
            </div>
            <div class="clear"></div>
            <img src="<?=$this->webroot?>images/merchant/mm-btm-shad.png" alt="" style="position:relative;right:4%; float:right; display:none;" />
            ...
            <div class="imgpanel1"><img src="<?=$this->webroot?><?=$attrs[2]->img?>" alt="" /></div>
            <div class="merchantright1">
              ...
              <img src="<?=$this->webroot?>images/merchant/arrowmrchnt1.png" alt="" style="position:relative; left: -8em;top: -1em; display:none;" />
            </div>
            <div class="clear"></div>
          ...
          <div class="features-icons-list "> 
            ...
            <div class="grid-item">
              ...
              <div class="iconlistdata"><img src="<?=$this->webroot?><?=$value->img?>" /></div>
    ...
    <div class="cta cta--blue row">
      ...
      <div class="freetag1"><img src="<?=$this->webroot?>img/arrow_next_1.png" hspace="10"/><span class="free_text">It's free</span></div></div>
