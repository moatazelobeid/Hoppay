  ...
  <div class="wrapper" >
					...
					<div>
                       ...
                       <!--  <div class="worksSteps">
                        	<a href="#fn1" title="">
                            	<img src="<?=$this->webroot?>img/stpeping2.jpg" alt="" />
                        	</a>
                        ...
                        <div class="worksSteps">
                        	<a href="#fn1" title="worksSteps">
                            	<img src="<?=$this->webroot?>img/stpeping3.jpg" alt="" />
                        	</a>
                        ...
                        <div class="worksSteps">
                        	<a href="#fn1" title="worksSteps">
                            	<img src="<?=$this->webroot?>img/stpeping4.jpg" alt="" />
                        	</a>
                        ...
                        <div class="worksSteps">
                        	<a href="#fn1" title="worksSteps">
                            	<img src="<?=$this->webroot?>img/stpeping5.png" alt="" />
                        	</a>
                    ...
                    <div class="videopan1" style="height:422px">
                    	...
                    	{
                    		echo "<img src='".$this->webroot.$video[0]->img."' style='width:100%;height:100%'>";
                    	}
                   ...
                   <?php /* ?> <div class="shadow2">&nbsp;</div>
					...
					<div class="MrT_NorDV">
						<div class="MrT_dv1">
							<img src="<?=$this->webroot?>images/front-end/homeslide/Bigstock_44483356.jpg" width="100%" height="100%" alt="" />
						</div>
