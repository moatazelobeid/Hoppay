                	...
                	<div class="right-content fr">
						<div class="breadcrumbs_pan">
							<div class="breadcrumbs fs12 l-hght26" style="float:left;">
								...
								<span class="crm">&nbsp;</span>
								<a class="fs12 c777 f-bold l-hght14" href="#"> Home <!-- <img src="images/home1.png" alt="" />--> </a>
								<span class="crm">&nbsp;</span>
							 	  ...
							 	  <li onclick="showdetailspan()">
									<span class="lazyImage loaded">
										<span alt="" class="itm-imageWrapper overfl-hid itm-imageWrapper-UR256WA22QYFINDFAS">
											<a href="#"><img class="itm-img" style="" src="images/mobil34.jpg" width="176" height="255" title="" alt=""></a>										</span>									</span>
...
<li onclick="showdetailspan()">
												<span class="lazyImage loaded">
													<span alt="" class="itm-imageWrapper overfl-hid itm-imageWrapper-UR256WA22QYFINDFAS">
														<a href="#"><img class="itm-img" style="" src="images/mobile2.jpg" width="176" height="255" title="" alt=""></a>										</span>									</span>
...
<li onclick="showdetailspan()">
												<span class="lazyImage loaded">
													<span alt="" class="itm-imageWrapper overfl-hid itm-imageWrapper-UR256WA22QYFINDFAS">
														<a href="#"><img class="itm-img" style="" src="images/Samsung-Galaxy-Note-3.jpg" width="176" height="255" title="" alt=""></a>										</span>									</span>
...
<li onclick="showdetailspan()">
												<span class="lazyImage loaded">
													<span alt="" class="itm-imageWrapper overfl-hid itm-imageWrapper-UR256WA22QYFINDFAS">
														<a href="#"><img class="itm-img" style="" src="images/mobile3.jpg" width="176" height="255" title="" alt=""></a>										</span>									</span>
...
<li onclick="showdetailspan()" style="margin-right:0;">
												<span class="lazyImage loaded">
													<span alt="" class="itm-imageWrapper overfl-hid itm-imageWrapper-UR256WA22QYFINDFAS">
														<a href="#"><img class="itm-img" style="" src="images/mobile6.jpg" width="176" height="255" title="" alt=""></a>										</span>									</span>
  ...
  <div class="clear">
							  ...
							  <div class="icon_close" onclick="showdetailspan()">&nbsp;</div>
									<div class="listclickpane">
										<div class="thumbnail-div">
											<a href="#">
												<img src="images/Samsung-Galaxy-Note-3.jpg" alt="" /></a>
											</a>
										</div>
										...
										<div class="thumbdata-div">
										  <h1>
												<a href="#">
													Samsung Galaxy S4 16GB LTE Black Frost <span style="font-size:13px;">(Price is the same as two weeks ago )</span>
												</a>
										  </h1>
						  ...
						  <ul id="productsCatalog list">
							  <li onclick="showdetailspan()">
												<span class="lazyImage loaded">
													<span alt="" class="itm-imageWrapper overfl-hid itm-imageWrapper-UR256WA22QYFINDFAS">
														<a href="#"><img class="itm-img" style="" src="images/Samsung-Galaxy-Note-3.jpg" width="176" height="255" alt="" title=""></a>										</span>									</span>
