...
<script type="text/javascript" language="javascript" src="<?=$this->webroot?>datepicker/prototype-1.js"></script>
<script type="text/javascript" language="javascript" src="<?=$this->webroot?>datepicker/prototype-base-extensions.js"></script>
<script type="text/javascript" language="javascript" src="<?=$this->webroot?>datepicker/prototype-date-extensions.js"></script>
<script type="text/javascript" language="javascript" src="<?=$this->webroot?>datepicker/behaviour.js"></script>
<script type="text/javascript" language="javascript" src="<?=$this->webroot?>datepicker/datepicker.js"></script>
<link rel="stylesheet" href="<?=$this->webroot?>datepicker/datepicker.css">
<script type="text/javascript" language="javascript" src="<?=$this->webroot?>datepicker/behaviors.js"></script>
                ...
                <table>
                  ...
                  <tr>
                   ...
                   <label>Schedule Time
                    ...
                    <td>
                    <input type="text" required name="schedule_time" class="datetimepicker" placeholder="Enter Schedule Time." autocomplete="off" readonly="readonly" style="width: 200px;" />
                    </td>
                 </tr>
                    <tr>
                      <td>
