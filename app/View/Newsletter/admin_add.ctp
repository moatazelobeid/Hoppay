...
<article class="module width_full">
    ...
    <a href="<?=$this->webroot?>admin/newsletter/add" class="heading_link">Add Newsletter</a>
    </header>
        ...
        <tr> 
           ...
           <input type="checkbox" data-id="<?=$val['Newsletter']['id']?>" class="user_checked <?=$val['Newsletter']['id']?>">
            ...
            <td>
              ...
              <a href="<?=$this->webroot?>admin/newsletter/delete/<?=$val['Newsletter']['id']?>">   <input type="image" src="<?=$this->webroot?>images/dashbord/icn_trash.png" title="Trash"></a>
            </td> 
