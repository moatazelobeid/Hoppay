...
#loadder_counter .pop_logo
{
	width:285px;
	height:71px;
	margin:0 auto;
}
#loadder_counter .pop_logo img
{
	width:284px;
	height:71px;
	border:none;
...
#loadder_counter .product_iconlink
{
	width: 200px;
	height: 120px;
	margin: 0 auto;
...
#loadder_counter .product_iconlink img
{
