	...
	foreach ($modelSchema as $field => $attributes): 
            ...
            echo ucwords(str_replace('_',' ',(isset($labelFieldList[$modelClass][$field]) ? $labelFieldList[$modelClass][$field] : ( isset($labelFieldList['*'][$field]) ? $labelFieldList['*'][$field] : $field ))));
            echo '</td>';
            echo '<td>';
