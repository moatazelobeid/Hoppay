...
class FCKeditor
{
	 ...
	 */
	function FCKeditor( $instanceName,$height = 200,$width = '100%',$toolbarType = 'Default' )
	{
	...
	function CreateHtml()
	{
		...
		else
		{
			...
			$Html .= "
			<textarea name=\&quot;{$this->InstanceName}\" id=\&quot;{$this->InstanceName}\" rows=\"4\" cols=\"40\" style=\"width: {$WidthCSS}; height: {$HeightCSS}\">{$HtmlValue}</textarea>
			" ;
		}
