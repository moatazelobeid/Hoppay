        ...
        <table width="190" border="0" cellspacing="2" cellpadding="2" style="float:left;">
            <tr>
                ...
                <table width="98%" border="0" cellspacing="0" cellpadding="0" style="border:solid 1px; border-color:#CCC;">
                    ...
                    <tr>
                        <td>&nbsp;</td>
                        <td height="40" colspan="2" align="left" valign="top"><span class="text1">Dept :</span> <span class="pricetext1"><?php echo $res_prod['department'];?></span></td>
                        </tr>
                    <tr>
                        <td>&nbsp;</td>
                        <td class="text1">Price :</td>
                        <td align="left" valign="middle" class="pricetext1"><?php echo $res_prod['price'];?>&nbsp;<?php echo $res_prod['currency'];?></td>
                    </tr>
                    <tr>
                        <td>&nbsp;</td>
                        <td>&nbsp;</td>
