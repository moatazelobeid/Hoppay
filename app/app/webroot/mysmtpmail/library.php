...
define("SMTP_UNAME", "singkishor@gmail.com"); //Username for SMTP authentication any valid email created in your domain
define("SMTP_PWORD", "prativasing"); //Password for SMTP authentication
