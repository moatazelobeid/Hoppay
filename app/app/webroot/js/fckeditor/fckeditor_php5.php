...
class FCKeditor
{
	 ...
	 */
	public function __construct( $instanceName,$height = 200,$width = '100%',$toolbarType = 'Default' )
 	{
		$this->InstanceName	= $instanceName ;
		$this->BasePath		= '/editor/' ;
		$this->Width		= $width ;
		$this->Height		= $height ;
		$this->ToolbarSet	= $toolbarType ;
		$this->Value		= '' ;
	...
	public function CreateHtml()
	{
		...
		else
		{
			...
			$Html .= "<textarea name=\"{$this->InstanceName}\" name=\"{$this->InstanceName}\" rows=\"4\" cols=\"40\" style=\"width: {$WidthCSS}; height: {$HeightCSS}\">{$HtmlValue}</textarea>" ;
		}
