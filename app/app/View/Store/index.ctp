                        ...
                        $links_social=isset($store_info['Product_store']['social_links'])?$store_info['Product_store']['social_links']:"";
                        	...
                        	$sociallinkss = json_decode($links_social);
                                     ...
                                     <tr>
                                       ...
                                       <img src="<?=$this->webroot?><?=isset($social_links['Social_setting']['image'])?$social_links['Social_setting']['image']:""?>" alt="hppay" style="padding-left:5px;float: left;margin-right: 6px;" height="20px" alt="hoppay">
                                       </label>
                                        </td>
