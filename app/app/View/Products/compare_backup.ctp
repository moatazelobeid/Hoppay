  ...
  $('#slide_details1').cycle({
    ...
    pagerAnchorBuilder: function(idx, slide) { 
      //console.log($(slide).find('img'));
          return '<li><a href="#"><img src="' + $(slide).find('img').attr('src') + '" width="60" height="60" /></a></li>'; 
      }  
  });
                          ...
                          <div class="product_topsec_det">
                                    <div itemscope="" itemtype="#">
                                      <div class="mspSingleTitle" id="mspSingleTitle" data-mspid="25149">
                                        ...
                                        <?=ucwords($product['Product_lang']['title'])?>
                                        </div>
                                      </div>
    ...
    var s = document.getElementsByTagName('script')[0]; s.parentNode.insertBefore(po, s);
                    ...
                    <div id="sellerLogoRating" style="margin:10px 0px" >                      
                      ...
                      <img title="<?=$allName[$key]?>" src="<?=$this->webroot?><?=($val!="")?$val:'img/no-image.png'?>" alt="<?=$allName[$key]?>" style="display:block; margin:0 auto;max-height: 80px;max-width: 98px;">
                                  ...
                                  <?php } */?>
                                  <div style="text-align: center;"><img src="<?=$this->webroot?>images/or.png" style="width: 47px;"></div>
                            <a href="#" class="linkonline" onclick="scrollUpone('one')"> <?=$this->Template->getWord('compare_all')?> <?=count($merchantids)?> <?=$this->Template->getWord('sallers')?> >></a>
                            <?php }else{ ?>
                       ...
                       <script>
                        ...
                        $merchant_id = $value['Merchant']['id'];
                                 ...
                                 <div class="ratingContener" data-type="merchant" data-id="<?=$merchant_id?>">
                                                    ...
                                                    <font style="position: relative;left: -17px;color: gray;font-size: 11px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(<?=$rcount?>)</font>
                                                    <div class="clear"></div>
            <a class="thickbox cleartextbox signin_top login-window2" 
            data-merchantId="<?=$merchant_id?>" data-merchantName="<?=ucfirst($merchant_website)?>" href="#merchant-reviews" style="/*text-align:center;display:block*/"><?=$this->Template->getWord('rate_this_seller')?></a>
                                                  </div>
                            ...
                            echo $shipping_name;
                                                ...
                                                <td class="maintop1" style="padding-right:0;">
                                                    ...
                                                    onClick="clickTrack('<?=$value['Product']['product_url']?>','<?=$value['Product']['id']?>','<?=$value['Product']['retailer_id']?>','<?=$product_price?>','<?=$merchant_logo?>','<?=$merchant_website?>','<?=$pimage?>','<?=addslashes($pname)?>');" title="Shop Now"><img src="<?=$this->webroot?>images/front-end/cart.png"><?=$this->Template->getWord('buy_on_seller');?></a>
                                                </td>
                                            </tr>
        ...
        <?php /*?><?php */?>
                                  ...
                                  <div class="colaps_class">
                                      ...
                                      <div id="ratings_tot1" class="showratings ratings_tot1">
                                                    ...
                                                    ?>
                                      <font style="color:#000; font-size:12px;padding-right:4px;<?=$style?>">(<?=$this->Template->getReviewText($ratingcount)?>)</font> 
