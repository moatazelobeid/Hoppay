  ...
  $('#slide_details1').cycle({
    ...
    pagerAnchorBuilder: function(idx, slide) { 
      //console.log($(slide).find('img'));
          return '<li><a href="#"><img src="' + $(slide).find('img').attr('src') + '" width="60" height="60"  alt="compare" /></a></li>'; 
      }  
  });
                                ...
                                <div id="slide_details1">
                                 ...
                                 <tr>
                                    <td valign="middle" style="height:100%;vertical-align: middle;">
                                       ...
                                       <img border="0" src="<?=$value?>"  alt="compare" title="" />
...
float: left;">
                           ...
                           // echo "sdkljfsdkf";
							...
							//echo "<pre>";print_r($product);exit;
														if(!empty($product['Product']['offer_id']) && ($product['Offer']['end_date'] >= $cdate) && ($product['Offer']['status'] == 1))
														{
															$pprice = $product['Product']['offer_price'];
															$prce = $product['Product']['price'] - (($product['Offer']['discount']/100) * $product['Product']['price']);
															...
															echo '<s>'.$this->Template->getPriceFormat(number_format($product['Product']['price'],2)).'</s><b>('.$product['Offer']['discount'].'%)</b>';
															echo '<span>'.$this->Template->getPriceFormat(number_format($prce,2));
															echo '</span></div>';
														}
														else
														{
    ...
    var s = document.getElementsByTagName('script')[0]; s.parentNode.insertBefore(po, s);
                    ...
                    <div id="sellerLogoRating" style="margin:10px 0px" >                      
                      ...
                      <img title="<?=$allName[$key]?>" src="<?=$this->webroot?><?=($val!="")?$val:'img/no-image.png'?>" alt="<?=$allName[$key]?>" style="display:block; margin:0 auto;max-height: 80px;max-width: 98px;">
                                  ...
                                  <?php } */?>
                                  <div style="text-align: center;"><img src="<?=$this->webroot?>images/or.png" alt="compare" style="width: 47px;"></div>
                              ...
                              $product_price_filter=$product_price;
                                                    ...
                                                    <div class="price_breakup">
													 ...
													 if(!empty($shipping_name))
													 {
														 ...
														 if($this->Template->getLang() == "ar" && $shipping_name == "Free Shipping"){
														 echo "شحن مجانا";
														 }else{
                        ...
                        if($this->Template->getLang() == "ar"){
                            ...
                            echo $shipping_name;
												...
												if(!empty($payment_methods))
												{
													...
													foreach($payment_methods as $pmethod=>$pval)
													{
														if($pval == 1)
														{
															if($pmethod == 'visa')
															{
																echo '<img src="'.$this->webroot.'images/front-end/Payment-method/visa.jpg" style="height:15px; width:26px;" alt="visa" > ';
															}
															if($pmethod == 'paypal')
															{
																echo '<img src="'.$this->webroot.'images/front-end/Payment-method/paypal.jpg" style="height:15px; width:26px;" alt="paypal" > ';
															}
															if($pmethod == 'mastercard')
															{
																echo '<img src="'.$this->webroot.'images/front-end/Payment-method/mastercard.jpg" style="height:15px; width:26px;" alt="mastercard" > ';
															}
															if($pmethod == 'SADAD')
															{
																echo '<img src="'.$this->webroot.'images/front-end/Payment-method/sadad.gif" style="height:15px; width:26px;" alt="sadad" > ';
															}
															if($pmethod == 'wire_transfer')
															{
																echo '<img src="'.$this->webroot.'images/front-end/Payment-method/wire_transfer.png" style="height:15px; width:26px;" alt="wire_transfer" > ';
															}
															if($pmethod == 'cod')
															{
																$cod = 1;
													...
													if($cod == 1)
													{
														 ...
														 if($this->Template->getLang() == "ar"){
														 echo '<div style="height:1px;" class="clear "></div> <span class="delivery_detail">الدفع عند التسليم</span>';
														 }else{
                                                ...
                                                <td class="maintop1" style="padding-right:0;">
                                                    ...
                                                    onClick="clickTrack('<?=$value['Product']['product_url']?>','<?=$value['Product']['id']?>','<?=$value['Product']['retailer_id']?>','<?=$product_price?>','<?=$merchant_logo?>','<?=$merchant_website?>','<?=$pimage?>','<?=addslashes($pname)?>');" title="Shop Now"><img src="<?=$this->webroot?>images/front-end/cart.png" alt="hoppay"><?=$this->Template->getWord('buy_on_seller');?></a>
                                                </td>
                                            </tr>
                                      ...
                                      <?php echo $this->Template->getWord("write_a_review"); ?>
                                                  ...
                                                  <div class="reviewpanle">
                                                    ...
                                                    <div class="reviewpanle_left">
                                                       <?php /*?> <img class="customer-profile-image" src="<?=$this->webroot?>images/front-end/usewr.png" alt="hoppay"><?php */ ?>
...
<!--<div class="scroll_top">
	...
	<p id="back-top">
        ...
        <img src="<?php echo $this->webroot;?>images/front-end/up-arrow.png" alt="direction to up">
        </span></a>
	</p>
