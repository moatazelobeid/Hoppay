...
<script src="<?php echo $this->webroot;?>js/front-end/jquery.min.js" type="text/javascript"></script> 
<script src="<?php echo $this->webroot;?>js/front-end/jquery.nouislider.min.js" type="text/javascript"></script> 
