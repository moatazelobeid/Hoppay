   ...
   */
     public function beforeFilter(){
      ...
      else
      {
		...
		public function admin_update($id="",$page=1)
		{
				 ...
				 if($check)
				  {
					...
					$this->redirect('/admin/newsletter/index/page:'.$page);
					exit();
				  }
		 ...
		 public function admin_delete($id,$page=1)
		 {
			...
			if($this->request->is('post'))
			{
				...
				//print_r($data);
				 if($check)
				  {
					$this->Session->setFlash('Successfully Updated! ', 'default', array(), 'msg');
					$this->redirect('/admin/newsletter/email_template');
					exit();
				  }
