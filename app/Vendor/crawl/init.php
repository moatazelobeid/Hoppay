...
Class CrawlInit
{
	...
	*/
	public function __construct($data=array()){
		...
		$this->merchant_url=$data['merchant_url'];
		//echo $this->merchant_url;
	...
	public function getDOM()
	{
     ...
     protected function doCalls($url){
     	//echo $url;
     	$ch = curl_init($url);
...
///$Crawl_merchant_website=ClassRegistry::init('Crawl_merchant_website');
///$crawl_data=  $Crawl_merchant_website->find('first',array('id'=>$id));
//print_r($crawl_data);
